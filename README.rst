...
First, download alcdef_read.py and place it in the same directory as your python script. Then import it as shown in Example 1, the file used in the example is also available above. 
